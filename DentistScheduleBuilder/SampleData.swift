...
class SampleData {
    ...
    lazy var events: [EventCellView.VM] = [
        EventCellView.VM(text: "Returning Visit", description: "Patient Name: Jack. \nReason: Tooth Decay.", start: firstDate, end: firstDate.add(component: .hour, value: 3)),
        EventCellView.VM(text: "Dental Training", description: "Gather Data About Patient", start: firstDate.startOfDay, end: firstDate.endOfDay, isAllDay: true, color: Color.google.emerald),
        EventCellView.VM(text: "Product Development", description: "Gather Data About Patient", start: firstDate.startOfDay, end: firstDate.endOfDay, isAllDay: true, color: Color.google.emerald),
        EventCellView.VM(text: "Dental Training", description: "Gather Data About Patient", start: secondDate.startOfDay, end: secondDate.endOfDay, isAllDay: true, color: Color.google.flamingo),
        EventCellView.VM(text: "Product Developement", description: "Gather Data About Patient", start: thirdDate.startOfDay, end: thirdDate.endOfDay, isAllDay: true, color: Color.google.grape),
        
        EventCellView.VM(text: "New Patient Visit", description: "Patient Name: Alice. \nPrepare for oral examination.", start: secondDate, end: secondDate.add(component: .hour, value: 4), color: Color.google.banana),
        
        EventCellView.VM(text: "Returning Visit", description: "Patient Name: Bob. \nReason: Initial treatment of aligner.", start: thirdDate, end: thirdDate.add(component: .hour, value: 3), color: Color.google.graphite)
    ]
}

extension Color {
    struct google {
        static var defaultColor = Color(#colorLiteral(red: 0.2196078431, green: 0.5215686275, blue: 0.7803921569, alpha: 1))
